...
#+begin_src emacs-lisp
  (pkg evil
    ...
    (evil-define-key 'normal 'global
      ...
      (kbd "<global-leader>d") (evil-define-command goto-dir-locals ()
                                 (find-file (concat (projectile-project-root) dir-locals-file)))
      (kbd "<global-leader>Dp") (evil-define-command add-dir-locals-project-commands ()
